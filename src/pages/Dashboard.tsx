...
export default function DashboardPage() {
  ...
  const getLikesForMaterial = (optionId: string) => {
    switch (optionId) {
      ...
      case "IMPL_FREILEGUNG": return likesMatImplFreilegung;
      case "IMPL_SOCKET_PRESERVATION": return likesMatImplSocket;
      case "IMPL_PERIIMPLANTITIS": return likesMatImplPeriimpl;
      case "KFO_MULTIBAND": return likesMatKfoMultiband;
      case "KFO_FKO": return likesMatKfoFko;
      case "KFO_RETAINER": return likesMatKfoRetainer;
      case "KFO_ALIGNER": return likesMatKfoAligner;
      case "PAR_AIT": return likesMatParAit;
      case "PAR_OFFEN": return likesMatParOffen;
      case "CHIR_EXTRAKTION_EIN": return likesMatChirExtEin;
      case "CHIR_EXTRAKTION_MEHR": return likesMatChirExtMehr;
      case "CHIR_INZISION": return likesMatChirInzision;
      case "CHIR_FRENEKTOMIE": return likesMatChirFrenektomie;
      case "CHIR_ZYSTEKTOMIE": return likesMatChirZystektomie;
      case "ENDO_STIFTAUFBAU": return likesMatEndoStift;
      case "DIVERS_SCHIENUNG": return likesMatDiversSchienung;
      case "DIVERS_BLEACHING": return likesMatDiversBleaching;
      case "DIVERS_MEDIKATION": return likesMatDiversMedikation;
      case "DIVERS_NOTFALL": return likesMatDiversNotfall;
      case "ZE_INLAY_ONLAY": return likesMatZeInlay;
      case "ZE_IMPLANTAT_PROTHETIK": return likesMatZeImplProt;
