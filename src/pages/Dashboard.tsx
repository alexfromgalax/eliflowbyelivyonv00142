...
export default function DashboardPage() {
  ...
  const likesParSrp = useLikes("tech-PAR_SRP");
  const likesParChir = useLikes("tech-PAR_CHIRURGISCH");
  ...
  const getLikesForTechniken = (optionId: string): ReturnType<typeof useLikes> => {
    switch (optionId) {
      ...
      case "PAR_SRP": return likesParSrp;
      case "PAR_CHIRURGISCH": return likesParChir;
